/**
 * BattlefieldDashboard.js - 战场仪表盘
 * V321 Iteration 9/9 FINAL Round 4
 */
export class BattlefieldDashboard {
    constructor(config = {}) {
    ...
    createDashboard(data) {
        ...
        const dashboard = { dashboardId: id, name: data.name || 'Unnamed', battleId: data.battleId, widgets: [], createdAt: Date.now(), lastRefresh: Date.now() };
