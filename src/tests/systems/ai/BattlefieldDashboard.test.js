/**
 * BattlefieldDashboard.test.js - 战场仪表盘测试
 * V321 Iteration 9/9 FINAL Round 4 - 测试覆盖率目标: 99%+
 */

import { describe, it, expect, beforeEach } from 'vitest';
import { BattlefieldDashboard } from '../../../systems/ai/BattlefieldDashboard.js';

describe('BattlefieldDashboard', () => {
    let system;
    beforeEach(() => { system = new BattlefieldDashboard(); });
    ...
    describe('createDashboard', () => {
        ...
        it('should initialize metrics', () => {
            const { dashboard } = system.createDashboard({});
            expect(system.metrics.has(dashboard.dashboardId)).toBe(true);
        });
    ...
    describe('addWidget', () => {
        it('should add', () => {
            const { dashboard } = system.createDashboard({});
            const result = system.addWidget(dashboard.dashboardId, { type: 'chart' });
    ...
    describe('removeWidget', () => {
        ...
        it('should remove from dashboard', () => {
            const { dashboard } = system.createDashboard({});
            const { widget } = system.addWidget(dashboard.dashboardId, {});
    ...
    describe('setMetrics', () => {
        it('should set', () => {
            const { dashboard } = system.createDashboard({});
            const result = system.setMetrics(dashboard.dashboardId, { casulties: 5 });
            expect(result.success).toBe(true);
        });

        it('should retrieve', () => {
            const { dashboard } = system.createDashboard({});
            system.setMetrics(dashboard.dashboardId, { casulties: 5 });
            expect(system.getMetrics(dashboard.dashboardId).casulties).toBe(5);
        });
    });
    ...
    describe('Persistence', () => {
        ...
        it('should deserialize', () => {
            system.createDashboard({});
            const json = system.toJSON();
            const newSys = new BattlefieldDashboard();
